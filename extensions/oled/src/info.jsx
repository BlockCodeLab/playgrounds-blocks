...
addLocalesMessages({
  en: {
    ...
    'blocks.oled.description': 'SSD1306/SSD1315 I2C monochrome display.',
  },
  'zh-Hans': {
    'blocks.oled.name': 'OLED 显示屏',
    'blocks.oled.description': 'SSD1306/SSD1315 I2C 单色显示屏。',
  },
  'zh-Hant': {
    'blocks.oled.name': 'OLED 顯示屏',
    'blocks.oled.description': 'SSD1306/SSD1315 I2C 單色顯示屏。',
  },
});
