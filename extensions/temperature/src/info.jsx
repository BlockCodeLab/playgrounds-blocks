...
addLocalesMessages({
  en: {
    ...
    'blocks.temperature.description': 'LM35/NL50/DS18B20 temperature sensors.',
  },
  'zh-Hans': {
    'blocks.temperature.name': '温度模块',
    'blocks.temperature.description': '使用 LM35/NL50/DS18B20 温度传感器。',
  },
  'zh-Hant': {
    'blocks.temperature.name': '溫度模組',
    'blocks.temperature.description': '使用 LM35/NL50/DS18B20 溫度傳感器。',
  },
});
